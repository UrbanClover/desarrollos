...
#SBATCH --output=snakefile_4_mutect_%j.out         # Salida
#SBATCH --error=snakefile_4_mutect_%j.err          # Errores
...
snakemake  -s snakefile_4_mutect "$@" --slurm --jobs 5 --cores 256 --rerun-incomplete