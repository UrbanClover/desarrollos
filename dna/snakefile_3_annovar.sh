...
#SBATCH --output=snakefile_3_annovar_%j.out         # Salida
#SBATCH --error=snakefile_3_annovar_%j.err          # Errores
...
snakemake  -s snakefile_3_annovar "$@" --slurm --jobs 5 --cores 256 --rerun-incomplete