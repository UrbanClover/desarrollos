...
#SBATCH --output=snakefile_completa_%j.out         # Salida
#SBATCH --error=snakefile_completa_%j.err          # Errores
...
snakemake  -s snakefile_completa "$@" --slurm --jobs 5 --cores 64 --rerun-incomplete
