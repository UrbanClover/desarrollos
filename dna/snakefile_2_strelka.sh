...
#SBATCH --output=snakefile_2_strelka_%j.out         # Salida
#SBATCH --error=snakefile_2_strelka_%j.err          # Errores
...
snakemake  -s snakefile_2_strelka "$@" --slurm --jobs 5 --cores 256 --rerun-incomplete