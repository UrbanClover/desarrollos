...
#SBATCH --output=snakefile_muestras_cancer_%j.out         # Salida
#SBATCH --error=snakefile_muestras_cancer_%j.err          # Errores
...
snakemake  -s snakefile_muestras_cancer "$@" --slurm --jobs 5 --cores 256 --rerun-incomplete